...
const gameImgContainer = document.getElementById('game-image-con');

games.forEach(game => {
  const subGameImageElement = document.createElement('div');
  subGameImageElement.className = 'sub-image-con';
  ...
  subGameImageElement.appendChild(gameImage);
  gameImgContainer.appendChild(subGameImageElement);
});
